...
const ClubAutocomplete = (props) => {
  ...
  const onClick = (e) => {
    ...
    // Call setSelectedClub here to update the selected country in the parent component
    props.setSelectedClub(e.currentTarget.innerText);
  };
  ...
  const onKeyDown = (e) => {
    if (e.keyCode === 13) {
      ...
      props.setSelectedClub(filtered[active]);
